        ...
        function () {
            ...
            tableIns = table.render({
                ...
                cols: [[ //列表数据
                    ...
                    {
                        field: 'isrenting', title: '出租状态', align: 'center', width: '90',
                        templet: function (d) {
                    ...
                    {
                        field: 'carimg', title: '缩略图', align: 'center', width: '80',
                        templet: function (d) {
            ...
            $("#doSearch").click(function () {
                var params = $("#searchFrm").serialize();// alert(params);
                tableIns.reload({
            ...
            upload.render({
                ...
                method: "post", //此处是为了演示之⽤，实际使⽤中请将此删除，默认⽤post⽅式提交acceptMime: 'images/*',
                field: "mf", done: function (res, index, upload) {
            ...
            table.on('tool(carTable)', function (obj) {
                ...
                var layEvent = obj.event; //获得 lay-event 对应的值（也可以是表头的event 参数对应的值）
                if (layEvent === 'del') { //删除
                    layer.confirm('真的删除【' + data.carnumber + '】这个⻋辆么？', function (index) {
                        //向服务端发送删除指令
