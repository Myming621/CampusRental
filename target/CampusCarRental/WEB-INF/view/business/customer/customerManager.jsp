...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            elem: '#customerTable',//渲染的⽬标对象
            url: '${pageContext.request.contextPath}/customer/loadAllCustomer.action',//数据接⼝
            title: '客户数据表',//数据导出来的标题
            toolbar: "#customerToolBar",//表格的⼯具条
            height: 'full-210',
