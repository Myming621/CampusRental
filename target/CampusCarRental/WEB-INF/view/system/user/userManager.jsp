    ...
    layui.extend({
        ...
        .use(['jquery', 'layer', 'form', 'table', 'dtree'], function () {
            ...
            tableIns = table.render({
                elem: '#userTable', //渲染的⽬标对象
                url: '${pageContext.request.contextPath}/user/loadAllUser.action',//数据接⼝
                title: '⽤户数据表',//数据导出来的标题
                toolbar: "#userToolBar", //表格的⼯具条
                height: 'full-210',
                ...
                cols: [[ //列表数据
                    ...
                    {field: 'realname', title: '⽤户姓名', align: 'center', width: '110'},
                    {field: 'loginname', title: '登陆名称', align: 'center', width: '110'},
                    {field: 'identity', title: '身份证号', align: 'center', width: '200'},
                    {field: 'phone', title: '⼿机号码', align: 'center', width: '140'},
                    {field: 'address', title: '⽤户地址', align: 'center', width: '130'},
                    {
                        field: 'sex', title: '性别', align: 'center', width: '90', templet: function (d) {
                            return d.sex == '1' ? '<font color=blue>男 </font>' : '<font color=red>⼥</font>';
                        }
                    },
                    {
                        field: 'available', title: '是否可⽤', align: 'center', width: '90', templet: function (d) {
                            return d.available == '1' ? '<fontcolor=blue>可⽤</font>' : '<font color=red>不可⽤</font>';
                        }
                    },
            ...
            function openAddUser() {
                mainIndex = layer.open({
                    ...
                    success: function (index) {
                        ...
                        $("#dataFrm")[0].reset();
                        url =
                            "${pageContext.request.contextPath}/user/addUser.action";
                    }
                });
            }
            ...
            function deleteBatch() {
                ...
                layer.confirm('真的要删除这些⽤户么？', function (index) {
                    //向服务端发送删除指令
            ...
            table.on('tool(userTable)', function (obj) {
                ...
                if (layEvent === 'del') { //删除
                    layer.confirm('真的删除【' + data.realname + '】这个⽤户么？',
                        function (index) {
                            //向服务端发送删除指令
                    ...
                    layer.confirm('真的重置【' + data.realname + '】这个⽤户的密码吗？', function (index) {
                        //向服务端发送重置密码
                ...
                mainIndex = layer.open({
                    ...
                    success: function (index) {
                        ...
                        var roleTableIns = table.render({
                            elem: '#roleTable' //渲染的⽬标对象
                            , url: '${pageContext.request.contextPath}/user/initUserRole.action?userid=' + data.userid //数据接⼝
                            , title: '⻆⾊列表'//数据导出来的标题
                            , cellMinWidth: 100 //设置列的最⼩默认宽度
                            , cols: [[ //列表数据
                                {type: 'checkbox', fixed: 'left'}
                                ...
                                , {field: 'roledesc', title: '⻆⾊备注', align: 'center'}
                            ]]
                        });
                    }
                });
