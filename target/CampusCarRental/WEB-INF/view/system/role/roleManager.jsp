...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/role/loadAllRole.action' //数据接⼝
            , title: '⽤户数据表'//数据导出来的标题
            , toolbar: "#roleToolBar" //表格的⼯具条
            , height: 'full-150'
            ...
            , cols: [[ //列表数据
                ...
                , {
                    field: 'rolename', title: '⻆⾊名称', align:
                        'center'
                }
                , {
                    field: 'roledesc', title: '⻆⾊备注', align:
                        'center'
                }
                , {
                    field: 'available', title: '是否可⽤', align:
                        'center', templet: function (d) {
                        return d.available == '1' ? '<font color=blue>可⽤</font>' : '<font color=red>不可⽤</font>';
                    }
                }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些⻆⾊么？', function (index) {
                //向服务端发送删除指令
        ...
        table.on('tool(roleTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rolename + '】这个⻆⾊么？',
                    function (index) {
                        //向服务端发送删除指令
