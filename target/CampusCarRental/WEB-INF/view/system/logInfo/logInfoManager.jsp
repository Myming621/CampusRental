    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'],
        function () {
            ...
            tableIns = table.render({
                elem: '#logInfoTable' //渲染的⽬标对象
                , url:
                    '${pageContext.request.contextPath}/logInfo/loadAllLogInfo.action'
                //数据接⼝
                , title: '⽤户数据表'//数据导出来的标题
                , toolbar: "#logInfoToolBar" //表格的⼯具条
                , height: 'full-190'
            ...
            table.on('tool(logInfoTable)', function (obj) {
                ...
                if (layEvent === 'del') { //删除
                    layer.confirm('真的删除【' + data.loginname + '】这个⽇志么？', function (index) {
                        //向服务端发送删除指令
            ...
            function deleteBatch() {
                ...
                layer.confirm('真的要删除这些⽇志么？', function (index) {
                    //向服务端发送删除指令
